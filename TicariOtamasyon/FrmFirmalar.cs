...
namespace TicariOtamasyon
{
    public partial class FrmFirmalar : Form
    {
        ...
        private void BtnKaydet_Click(object sender, EventArgs e)
        {
            ...
            komut.Parameters.Add("@P2", TxtYetkiliGorev.Text);
            komut.Parameters.Add("@P3", TxtYetkili.Text);
            komut.Parameters.Add("@P4", MskYetkiliTC.Text);
            komut.Parameters.Add("@P5", TxtSektor.Text);
            komut.Parameters.Add("@P6", MskTelefon1.Text);
            komut.Parameters.Add("@P7", MskTelefon2.Text);
            komut.Parameters.Add("@P8", MskTelefon3.Text);
            komut.Parameters.Add("@P9", TxtMail.Text);
            komut.Parameters.Add("@P10", MskFax.Text);
            komut.Parameters.Add("@P11", Cmbil.Text);
            komut.Parameters.Add("@P12", Cmbilce.Text);
            komut.Parameters.Add("@P13", TxtVergi.Text);
            komut.Parameters.Add("@P14", RchAdres.Text);
            komut.Parameters.Add("@P15", TxtKod1.Text);
            komut.Parameters.Add("@P16", TxtKod2.Text);
            komut.Parameters.Add("@P17", TxtKod3.Text);
