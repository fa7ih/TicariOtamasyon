    ...
    public partial class FrmKasa : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (sayac > 0 && sayac <= 5)
            {
                ...
                SqlCommand komut10 = new SqlCommand("Select top 4 AY,ELEKTRIK from  order by ID Desc", bgl.baglanti());
            ...
            if (sayac > 5 && sayac <= 10)
            {
                ...
                chartControl1.Series["Aylar"].Points.Clear();
                SqlCommand komut11 = new SqlCommand("Select Top 4 AY,SU from  order by ID Desc", bgl.baglanti());
